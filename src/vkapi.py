...
#   - вести интервал для каждого токена отдельно
#   - проверить производительность. Возможно лучше будет использовать Процессы вместо Потоков или использовать libuv
